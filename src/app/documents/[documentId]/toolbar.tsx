...
const LinkButton = () => {
  ...
  const updateButtonValue = (open: boolean) => {
    if (open) {
  ...
  return (
    <DropdownMenu onOpenChange={updateButtonValue}>
      <DropdownMenuTrigger asChild>
        <button className="h-7 min-w-7 shrink-0 flex flex-col items-center justify-center rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm">
    ...
    <div className="flex items-center gap-x-0.5">
      ...
      {isEditing ? (
        <input
          ...
          className="h-7 w-10 text-sm text-center border border-neutral-400 rounded-sm bg-transparent focus:outline-hidden focus:ring-0"
        />
      ) : (
        <button
          onClick={() => {
